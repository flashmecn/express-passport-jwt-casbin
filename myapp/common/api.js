...
exports.roleedit = function (data) {
    return new Promise(function (resolve, reject) {
        ...
        db.executeSql('update role set ' + str.slice(0, -1) + ' where ' + Object.keys(data)[0] + '=' + Object.values(data)[0], function (err) {
            resolve(err);
        });
    })
}
//修改角色等级
exports.rolelevel = function (data) {
    return new Promise(function (resolve, reject) {
        db.executeSql('update role set level="' + data.newsort + '" where name="' + data.sortid+'"', function (err) {
            if (!err) {
                //修改子集路径
