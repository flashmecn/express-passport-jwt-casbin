...
router.get('/list', authz.authz({ newEnforcer: enforcer }), function (req, res, next) {
...
router.post('/add', authz.authz({ newEnforcer: enforcer }), function (req, res, next) {
...
router.post('/del', authz.authz({ newEnforcer: enforcer }), function (req, res, next) {
...
router.post('/edit', authz.authz({ newEnforcer: enforcer }), function (req, res, next) {
  var id = req.body.id.trim();
  var name = req.body.name.trim();
  var password = req.body.password.trim();
  var role = req.body.role.trim();
